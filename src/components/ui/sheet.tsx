...
function SheetClose({
  ...
  return <SheetPrimitive.Close data-slot="sheet-close" asChild {...props} />
}
    ...
    <SheetPortal>
      ...
      >
        ...
        <SheetPrimitive.Close
          ...
          className="absolute right-4 top-4 rounded-xs opacity-70 transition-opacity outline-none hover:opacity-100 focus-visible:ring-ring/50 focus-visible:ring-[3px] focus-visible:ring-ring"
        >
          <X className="size-4" />
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("font-montserrat font-bold text-lg", className)}
      {...props}
    />
  )
}
